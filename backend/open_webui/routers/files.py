...
from open_webui.utils.code_interpreter import CodeGeneratedFileManager
...
############################
# Download Code Generated File
############################


@router.get("/code-generated/{file_id}/download")
async def download_code_generated_file(file_id: str, user=Depends(get_verified_user)):
    """Download a file generated by code interpreter"""
    try:
        file_manager = CodeGeneratedFileManager()
        file_path, filename = file_manager.get_file_for_download(file_id, user.id)
        ...
        log.exception(f"Error downloading code generated file: {e}")
        raise HTTPException(
